# Generated by Django 4.2 on 2025-02-07 20:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100)),
                ('description', models.FileField(blank=True, null=True, upload_to='image')),
                ('image', models.FileField(blank=True, null=True, upload_to='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.FileField(blank=True, null=True, upload_to='image')),
                ('reply', models.FileField(blank=True, null=True, upload_to='image')),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.post')),
            ],
            options={
